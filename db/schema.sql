-- HLPL BI Dashboard — shared database schema.
-- Run once against the Neon/Vercel Postgres database before first use.
-- Safe to re-run: every statement is IF NOT EXISTS.

-- ---------------------------------------------------------------------------
-- Auth. Accounts are admin-created only — there is no signup route, so a row
-- existing here is what grants access.
-- ---------------------------------------------------------------------------
